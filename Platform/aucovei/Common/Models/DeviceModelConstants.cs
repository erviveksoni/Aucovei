namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.Common.Models
{
    ...
    public static class DevicePropertiesConstants
    {
        ...
        public const string BATTERY_CAPACITY = "BatteryCapacity";
        public const string OPERATING_VOLTAGE = "OperatingVoltage";
        public const string LPOADING_CAPACITY = "LoadingCapacity";
        public const string WHEEL_BASE = "WheelBase";
        public const string MAX_OPERATING_TEMP = "MaxOperatingTemp";
