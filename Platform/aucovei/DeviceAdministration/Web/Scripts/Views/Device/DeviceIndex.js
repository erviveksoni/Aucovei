IoTApp.createModule('IoTApp.DeviceIndex', function () {
    ...
    var initDetails = function () {
        ...
        if (deviceId) {
            self.deviceDetails.init(deviceId, deviceDetailsSettings);
        }
    }
    ...
    var _initializeDatatable = function() {
        ...
        var onTableRowClicked = function () {
            ...
            self.deviceDetails.init(data, deviceDetailsSettings);
        ...
        self.dataTable = self.dataTableContainer.DataTable({
            ...
            "columns": [
                ...
                {
                    "data": "DeviceProperties.BatteryCapacity",
                    "mRender": function (data) {
                        return htmlEncode(data);
                    },
                ...
                {
                    "data": "DeviceProperties.OperatingVoltage",
                    "mRender": function (data) {
                        return htmlEncode(data);
                    },
                ...
                {
                    "data": "DeviceProperties.LoadingCapacity",
                    "mRender": function (data) {
                        return htmlEncode(data);
                    },
                ...
                {
                    "data": "DeviceProperties.WheelBase",
                    "mRender": function (data) {
                        return htmlEncode(data);
                    },
                    "name": "wheelBase"
                ...
                {
                    "data": "DeviceProperties.MaxOperatingTemp",
                    "mRender": function (data) {
                        return htmlEncode(data);
                    },
