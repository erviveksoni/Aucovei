...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.DeviceAdmin.Infrastructure.BusinessLogic
{
    ...
    public class DeviceTelemetryLogic : IDeviceTelemetryLogic
    {
        ...
        {
            return await _deviceTelemetryRepository.LoadWavepointForRoute(routeId, pointId);
        }

        public async Task<RouteWavepointListModel> LoadWavepointsListForRoute(string routeId)
        {
            return await _deviceTelemetryRepository.LoadWavepointsListForRoute(routeId);
        }
